import 'package:yum_application/src/features/ingredients/data/datasource/remote_datasource.dart';
...
class IngredientRepositoryImpl implements IngredientRepository {
  final RemoteIngredientApi remoteDatasource;
  ...
  Stream<List<RefreginatorIngredient>> getMyIngredient() {
    return remoteDatasource.getMyIngredient();
  }
