...
final class RefreginatorIngredientListState extends Equatable {
  ...
  ///
  ///
  List<IngredientEntity> filteredIngredientsAt(DateTime now) {
    return ingredients
  ...
  ///
  ///
  List<IngredientEntity> myFreezedIngredientsAt(DateTime now) =>
  ...
  List<IngredientEntity> myUnfreezedIngredientsAt(DateTime now) =>
      filteredIngredientsAt(now)
          .where((ingredient) => !ingredient.isFreezed)
          .toList();
