...
class SelectIngredientImage extends ConsumerStatefulWidget {
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SelectIngredientImageState();
}

class _SelectIngredientImageState extends ConsumerState<SelectIngredientImage>
  ...
  void toggle() {
    final isFreezed =
        ref.watch(createRefreginatorIngredientViewModelProvider).isFreezed;
